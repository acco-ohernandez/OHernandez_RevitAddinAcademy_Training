...
namespace RevitAddinAcademy
{
    ...
    public class TestCode : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            dlgOpen.Filter = "FILES XLSX|*.XLSX|FILES XLS|*.XLS";
            dlgOpen.Multiselect = false;
            dlgOpen.Title = "Select Excel file for reading";

            System.Windows.Forms.DialogResult dialogResult = dlgOpen.ShowDialog();
            string excelFile = dlgOpen.FileName;



            Excel.Application excelApp = new Excel.Application();
            Excel.Workbook excelWb = (Excel.Workbook)excelApp.Workbooks.Open(excelFile);
